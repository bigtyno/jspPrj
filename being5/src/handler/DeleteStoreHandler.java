...
public class DeleteStoreHandler implements CommandHandler {
	private DeleteStoreService deleteService = new DeleteStoreService();
...
//		}
		...
		try {
			...
			return "/WEB-INF/view/store/StoreDeleteSuccess.jsp";
